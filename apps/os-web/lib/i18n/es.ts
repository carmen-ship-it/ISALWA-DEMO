export const es = {
  ...
  pages: {
    inicio: {
      title: 'Inicio',
      kicker: 'Hoy',
      description: '¿Qué necesita mi atención hoy? Solo hechos de trabajo, aprobaciones, incidencias y compromisos.',
      attention: 'Necesita atención',
      attentionEmpty: 'No tienes pendientes para hoy.',
      attentionUnavailable: 'No se pudo cargar lo que necesita atención.',
