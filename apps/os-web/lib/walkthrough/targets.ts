...
export const TOUR_TARGET = {
  ...
  // First-use / micro-tour surface hooks
  ...
  produccionSave: 'produccion-save',
  almacenActions: 'almacen-actions',
  comprasFilter: 'compras-filter',
  coordinationHistory: 'coordination-history',
  financeProvenance: 'finance-provenance',
