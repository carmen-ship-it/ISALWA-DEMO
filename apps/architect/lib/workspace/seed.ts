...
function seedWorkspace(input: {
  ...
  const timeline: TimelineEvent[] = [
    {
      ...
      description: `Se inició el descubrimiento para ${input.companyName}.`,
      category: "meeting",
    },
    {
      id: createId("timeline"),
      ...
      title: "Contexto comercial capturado",
    ...
    },
    {
      ...
      workspaceId: input.id,
      date: updatedAt,
      title: "Puntos de dolor confirmados",
  ...
  const person: Person = {
    ...
    email: null,
    phone: null,
    notes: "Contacto principal del descubrimiento",
    lastSeen: updatedAt,
  };
  ...
  const meeting: Meeting = {
    id: meetingId,
    workspaceId: input.id,
    title: "Sesión de descubrimiento 1",
    date: daysAgo(input.daysSinceActivity + 1),
    participants: [input.personName],
    conversationId: null,
    interviewId: null,
    summary: `Se cubrió el movimiento comercial y las herramientas actuales de ${input.companyName}.`,
  ...
  const modules: Module[] = input.modules.map((name, index) => ({
    ...
    name,
    purpose: `Cierra las brechas de ${name.toLowerCase()} identificadas en el descubrimiento.`,
  ...
  const recommendations: Recommendation[] = input.modules.slice(0, 2).map((name) => ({
    id: createId("rec"),
    title: `Introducir ${moduleLabel(name)}`,
    rationale: `La evidencia del descubrimiento sugiere que ${moduleLabel(name).toLowerCase()} es un punto de partida de alto impacto.`,
    priority: "now",
  ...
  const documents: Document[] = [
    {
      ...
      title: "Transcripción de la sesión de descubrimiento 1",
    ...
    ? [
        {
          ...
          title: `Arquitectura de solución · Blueprint v${solutionArchitecture.blueprintVersion}`,
    ...
    ? [
        {
          ...
          title: `Procesos de negocio · Blueprint v${businessProcesses.blueprintVersion}`,
    ...
    ? [
        {
          ...
          title: `Marca y experiencia · Blueprint v${brandExperience.blueprintVersion}`,
    ...
    ? [
        {
          ...
          title: `Modelo de la empresa · Blueprint v${companyModel.blueprintVersion}`,
    ...
    ? [
        {
          ...
          title: `Entregables · Blueprint v${deliverables.blueprintVersion ?? 1}`,
    ...
    ? [
        {
          ...
          title: implementationPackage.gate.ready
            ? `Paquete de implementación · Blueprint v${implementationPackage.blueprintVersion ?? 1}`
            : `Paquete de implementación (pendiente) · ${input.companyName}`,
