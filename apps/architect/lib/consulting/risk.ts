...
/**
 * Exported so `lib/consulting/normalize.ts` can refresh persisted risk copy
 * by `patternId` — the pattern id is a stable enum, so this stays safe even
 * if a workspace's risks were generated by an older/English copy version.
 */
