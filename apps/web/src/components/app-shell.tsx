...
export function AppShell({
  ...
  return (
    <>
        ...
        <aside className="border-b border-[var(--isalwa-mist)] bg-[var(--isalwa-kiln)] text-[var(--isalwa-porcelain)] md:sticky md:top-0 md:h-screen md:border-b-0 md:border-r md:border-[color-mix(in_srgb,white_8%,transparent)]">
          <div className="flex items-center justify-between gap-2 px-5 py-5">
            ...
            <kbd
              ...
              className="hidden rounded border border-[color-mix(in_srgb,white_14%,transparent)] px-1.5 py-0.5 text-[10px] tracking-wide text-[color-mix(in_srgb,white_45%,transparent)] md:inline"
            >
              ⌘K
            </kbd>
          </div>
                ...
                >
                  ...
                  <span
                    className={cx(
                      ...
                      isActive
                        ? 'text-[color-mix(in_srgb,white_55%,transparent)]'
                        : 'text-[color-mix(in_srgb,white_32%,transparent)]',
                    )}
                  >
                    {item.hint}
                  </span>
      ...
      {/* Guided tour overlay — fixed position, renders above the layout */}
      <GuidedTour />
    </>
  );
}
