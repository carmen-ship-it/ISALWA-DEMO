 ...
 * Finished-goods handoff stays UNPROVEN when the receipt port is not connected.
...
import { readFinishedGoodsReceipts, type FinishedGoodsReceiptFact } from './finished-goods-reader';
...
import { COMPANY_OPERATING_READ_SCOPE, type ReadResult } from './source-state';
...
export async function readCompanyOperatingStores(input: {
  ...
  finishedGoodsReceipts: ReadResult<FinishedGoodsReceiptFact>;
